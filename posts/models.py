...
class Question(models.Model):
    ...
    input_format = models.TextField(max_length=200)
    output_format = models.TextField(max_length=200)
    input_example = models.TextField(max_length=500)
    output_example = models.TextField(max_length=500)
